...
def print_cli(p):
    ...
    print_value("thabits.list")
    print_value("republican.name")
    print_value("republican.count")
    print_value("republican.first")
    print_value("republican.last")
    print_value("republican.list")
    print_value("democratic.name")
    print_value("democratic.count")
    print_value("democratic.first")
    print_value("democratic.last")
    print_value("democratic.list")
    print_value("centrist.name")
    print_value("centrist.count")
    print_value("centrist.first")
    print_value("centrist.last")
    print_value("centrist.list")
